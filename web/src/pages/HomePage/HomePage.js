  ...
  return (
    <>
      <section className="bg-white py-8">
        <div className="flex flex-col container max-w-5xl mx-auto m-8">
          <h1 className="w-full my-2 text-5xl font-bold leading-tight text-center ">
            Nifty Chess
          </h1>
          <div className="w-full mb-4">
            <div className="h-1 mx-auto gradient w-64 text-center my-0 py-0 rounded-t ">
          ...
          <Link
            to={routes.newGame()}
            type="submit"
            className="flex w-16 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg"
          >
            Save your Game
          </Link>
        </div>
